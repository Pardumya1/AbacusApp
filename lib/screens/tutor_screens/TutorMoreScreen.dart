import 'package:abacus_app/screens/marge_screens/play_game.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import '../marge_screens/about_us.dart';
import '../marge_screens/contact_us_screen.dart';
import 'TutorCompensationClassScreen.dart';

class TutorMoreScreen extends StatefulWidget {
  static const String routeName = '/TutorMoreScreen';

  const TutorMoreScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _TutorMoreScreen();

}

class _TutorMoreScreen extends State<TutorMoreScreen> with WidgetsBindingObserver {
        ...
        onTap: () =>(() {
          ...
          if(itemNo == 2){
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const TutorCompensationClassScreen(),
              ),
            );
          }
          else if(itemNo == 0){
